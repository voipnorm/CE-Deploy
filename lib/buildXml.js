...
module.exports = {
    ...
    disableAssistant: function() {
        return new Promise(resolve => {
            var xml2 = `
                <Configuration>
                    <UserInterface>
	                    <Assistant>
		                    <Allowed valueSpaceRef="/Valuespace/TTPAR_OnOff" hidden="True">On</Allowed>
		                    <Mode valueSpaceRef="/Valuespace/TTPAR_OnOff">Off</Mode>
		                    <ProactiveMeetingJoin valueSpaceRef="/Valuespace/TTPAR_TrueFalse">False</ProactiveMeetingJoin>
	                    </Assistant>
                    </UserInterface>
                </Configuration>`;
            resolve(xml2)
