...
function sendForm(event){
    ...
    if(!document.getElementById("inRoom").files.length == 0 ||!document.getElementById("inRoomConfig").files.length == 0){
    ...
    if(document.getElementById("disableAssist").checked === true){
        disableAssist = 'true';
    }
